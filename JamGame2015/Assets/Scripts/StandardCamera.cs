...
public class StandardCamera : MonoBehaviour
{
    ...
    public class InputSettings
    {
        ...
        public string MOUSE_ORBIT_X = "MouseOrbitX";
        public string ORBIT_Y_SNAP = "OrbitYSnap";
        public string ORBIT_Y = "OrbitY";
        public string ORBIT_X = "OrbitX";
    ...
    void GetInput()
    {
        xOrbitInput = Input.GetAxisRaw(input.ORBIT_X);
        yOrbitInput = Input.GetAxisRaw(input.ORBIT_Y);
        yOrbitSnapInput = Input.GetAxisRaw(input.ORBIT_Y_SNAP);
        zoomInput = Input.GetAxisRaw(input.ZOOM);
        mouseOrbitInput = Input.GetAxisRaw(input.MOUSE_ORBIT);
        xMouseOrbitInput = Input.GetAxisRaw(input.MOUSE_ORBIT_X);
    }
    ...
    void OrbitTarget()
    {
        ...
        orbit.xRotation += -xOrbitInput * orbit.vOrbitSmooth;
        orbit.yRotation += -yOrbitInput * orbit.hOrbitSmooth;
